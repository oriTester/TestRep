...
public class WebRtcClient {
    ...
    public interface RtcListener {
        ...
        void onStatusChanged(WebRtcClient.WebRtcStatus newStatus);
    ...
    private class Peer implements SdpObserver, PeerConnection.Observer {
        ...
        public void onIceConnectionChange(PeerConnection.IceConnectionState iceConnectionState) {
            if (iceConnectionState == PeerConnection.IceConnectionState.DISCONNECTED) {
                removePeer(id);
                mListener.onStatusChanged(WebRtcStatus.DISCONNECTED);
            }
        }
        ...
        public Peer(String id, int endPoint) {
            ...
            mListener.onStatusChanged(WebRtcStatus.CONNECTED);
        }
    }
    ...
    public void onDestroy() {
        synchronized (quit[0]) {
            ...
            if (videoSource != null) {
                videoSource.stop();
               // videoSource.dispose(); crashed if call not initiated
                videoSource = null;
            }
    ...
    private void setCamera() {
        ...
        if (pcParams.videoCallEnabled) {
            ...
            videoCapturerAndroid = getVideoCapture();
